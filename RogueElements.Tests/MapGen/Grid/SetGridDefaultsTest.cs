...
namespace RogueElements.Tests
{
    ...
    public class SetGridDefaultsTest
    {
        ...
        public void StraightPath0Percent()
        {
            ...
            var pathGen = new SetGridDefaultsStep<IGridPathTestContext, TestTile> { DefaultRatio = new RandRange(0) };
        ...
        public void StraightPath50Percent()
        {
            ...
            var pathGen = new SetGridDefaultsStep<IGridPathTestContext, TestTile> { DefaultRatio = new RandRange(50) };
            ...
            Assert.That(floorPlan.GetRoomPlan(0).RoomGen, Is.TypeOf<TestGridRoomGen>());
            Assert.That(floorPlan.GetRoomPlan(1).RoomGen, Is.TypeOf<RoomGenDefault<IGridPathTestContext, TestTile>>());
            Assert.That(floorPlan.GetRoomPlan(2).RoomGen, Is.TypeOf<RoomGenDefault<IGridPathTestContext, TestTile>>());
            Assert.That(floorPlan.GetRoomPlan(3).RoomGen, Is.TypeOf<TestGridRoomGen>());
            Assert.That(floorPlan.GetRoomPlan(4).RoomGen, Is.TypeOf<TestGridRoomGen>());
        ...
        public void StraightPath100Percent()
        {
            ...
            var pathGen = new SetGridDefaultsStep<IGridPathTestContext, TestTile> { DefaultRatio = new RandRange(100) };
            ...
            Assert.That(floorPlan.GetRoomPlan(1).RoomGen, Is.TypeOf<RoomGenDefault<IGridPathTestContext, TestTile>>());
            Assert.That(floorPlan.GetRoomPlan(2).RoomGen, Is.TypeOf<RoomGenDefault<IGridPathTestContext, TestTile>>());
            Assert.That(floorPlan.GetRoomPlan(3).RoomGen, Is.TypeOf<RoomGenDefault<IGridPathTestContext, TestTile>>());
            Assert.That(floorPlan.GetRoomPlan(4).RoomGen, Is.TypeOf<TestGridRoomGen>());
        }
        ...
        public void Immutable100Percent()
        {
            ...
            TestGridFloorPlan floorPlan = TestGridFloorPlan.InitGridToContext(inGrid);
            GridRoomPlan<TestTile> roomPlan = floorPlan.GetRoomPlan(2);
