...
namespace RogueElements
{
    ...
    [Serializable]
    public class AddConnectedRoomsRandStep<TGenContext, TTile> : AddConnectedRoomsBaseStep<TGenContext, TTile>
        ...
        where TTile : ITile<TTile>
    {
        ...
        public AddConnectedRoomsRandStep(IRandPicker<RoomGen<TGenContext, TTile>> genericRooms, IRandPicker<PermissiveRoomGen<TGenContext, TTile>> genericHalls)
        ...
        public override FloorPathBranch<TGenContext, TTile>.ListPathBranchExpansion? ChooseRoomExpansion(IRandom rand, FloorPlan<TTile> floorPlan)
        {
            ...
            return FloorPathBranch<TGenContext, TTile>.ChooseRandRoomExpansion(room, hall, rand, floorPlan, availableExpansions);
        }
    }
}
